...
func runTUI(path string, content string) error {
	...
	cfg.ShowCurrentDirOnly = showCurrentDirOnly
...
func init() {
	...
	rootCmd.Flags().BoolVarP(&showCurrentDirOnly, "current", "c", false, "show files in current directory only (TUI-mode only)")
